function Get-DockerVolume {
    ...
    if ($Name.Length -eq 0) {
        ...
        foreach ($line in $net) {
            ...
            $volume | Add-Member -MemberType NoteProperty -Name Name -Value $result.Matches.Groups[2].Value
            $volume | Add-Member -MemberType NoteProperty -Name Driver -Value $result.Matches.Groups[1].Value
